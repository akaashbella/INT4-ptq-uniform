#!/bin/bash
#SBATCH -J ptq-tin-eval-fp32-cls
#SBATCH -p dgxh
#SBATCH --gres=gpu:1
...
# FP32 eval for classification runs (requires trained checkpoint in OUTPUT_ROOT).
...
echo "Starting EVAL FP32 classification: model=${model} regime=${regime} seed=${seed}"
