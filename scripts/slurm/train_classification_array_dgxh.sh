...
# Tiny ImageNet classification training — one job per (model, regime, seed).
...
echo "Starting TRAIN classification: model=${model} regime=${regime} seed=${seed}"
